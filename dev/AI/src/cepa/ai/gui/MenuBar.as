package cepa.ai.gui
{
	...
	public class MenuBar extends Sprite
	{
		...
		public function addButton(spr:Sprite, descricao:String = "", func:Function=null):void
		{
			spr.x = BTN_WIDTH / 2;
		...
		public function getButton(string:String):Sprite 
		{
			return Sprite(this.getChildByName(string));
		}
		...
		private function createToolTip(spr:Sprite, descricao:String):void 
		{
			...
			if(stage!=null) stage.addChild(btnTT);
		}
		...
		private function makeButton(spr:Sprite, func:Function):void 
		{
			...
			if(func!=null) spr.addEventListener(MouseEvent.CLICK, func);
		}
